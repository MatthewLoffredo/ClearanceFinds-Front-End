...
const Layout = props => {
  ...
  const searchWithoutEvent = () => {
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_2___default()('http://clearancegood-env.xe4i3r2rmx.us-east-2.elasticbeanstalk.com/goods?q=' + searchQuery).then(function (response) {
...
Index.getInitialProps = async function () {
  const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()('http://clearancegood-env.xe4i3r2rmx.us-east-2.elasticbeanstalk.com/goods');
